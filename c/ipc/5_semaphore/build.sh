...
clang -Wall -Wextra -o shm_write_with_semaphore shm_write_with_semaphore.c
clang -Wall -Wextra -o shm_read_cntr shm_read_cntr.c
clang -Wall -Wextra -o shm_write_cntr shm_write_cntr.c
